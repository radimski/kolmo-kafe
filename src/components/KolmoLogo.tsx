...
const letters = [
  ...
  { char: "O", x: 36, y: 158, delay: 125 },
  { char: "L", x: 36, y: 238, delay: 250 },
  { char: "M", x: 36, y: 318, delay: 500 },
  { char: "O", x: 36, y: 398, delay: 625 },
] as const;
...
export function KolmoLogo({
  ...
  const svg = (
    ...
    >
      ...
      <g
        className={letterClass}
        style={animate ? { animationDelay: "375ms" } : undefined}
      >
      ...
      <g
        className={letterClass}
        style={animate ? { animationDelay: "440ms" } : undefined}
      >
        <path
